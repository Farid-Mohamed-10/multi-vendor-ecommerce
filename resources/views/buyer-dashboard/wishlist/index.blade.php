    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                ...
                <p class="text-sm text-gray-400 mt-0.5">Products you've saved for later</p>
            </div>
        </div>
                        ...
                        <div class="bg-white rounded-2xl overflow-hidden group transition-all hover:shadow-lg"
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span
                                        class="text-lg font-bold text-purple-600">${{ number_format($product->price, 2) }}</span>
                                    <a href="{{ route('front.show-product', $product) }}"
                                        class="px-3 py-1.5 rounded-lg text-xs font-semibold text-purple-600 border border-purple-200 hover:bg-purple-50 hover:border-purple-300 transition-colors">
                                        View Product
                                    </a>
                                </div>
                            </div>
        ...
        @else
            <div class="bg-white rounded-2xl p-16 text-center" style="box-shadow:0 2px 12px rgba(139,92,246,0.07)">
                <div class="flex flex-col items-center gap-3">
                    ...
                    <a href="{{ route('front.products') }}" class="text-xs text-purple-600 font-semibold hover:underline">
                        Browse products →
                    </a>
                </div>
            </div>
