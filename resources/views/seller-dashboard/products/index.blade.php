...
@section('content')
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <a href="{{ route('seller-dashboard.products.create') }}"
        ...
        {{-- search + filters --}}
        <div class="w-full">
            <form action="{{ route('seller-dashboard.products.index') }}" method="GET"
                ...
                <table class="w-full text-sm min-w-[800px]">
                    <thead>
                        <tr class="text-left text-xs text-gray-400 border-b border-gray-100">
                            ...
                            <th class="px-6 py-4 font-medium">Original Price</th>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        @forelse ($products as $product)
                            <tr class="hover:bg-purple-50/20 transition-colors">
                                ...
                                <td class="px-6 py-4 text-gray-500">${{ $product->original_price }}</td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('seller-dashboard.products.show', $product) }}"
                                        ...
                                        <a href="{{ route('seller-dashboard.products.edit', $product) }}"
                                        ...
                                        <form action="{{ route('seller-dashboard.products.destroy', $product) }}"
