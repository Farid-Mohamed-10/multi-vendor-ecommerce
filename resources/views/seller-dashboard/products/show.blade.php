    ...
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            ...
            <div class="flex gap-2">
                ...
                <form action="{{ route('seller-dashboard.products.destroy', $product) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button
                    ...
                    <div class="flex gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                <div>
                                    <h2 class="text-sm font-bold text-gray-700">Price</h2>
                                    <span
                                        class="text-2xl font-bold text-gray-800">${{ number_format($product->price, 2) }}</span>
                                </div>
                                <div>
                                    <h2 class="text-sm font-bold text-gray-700">Original Price</h2>
                                    <span
