    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex items-center justify-between mb-6 flex-wrap gap-3">
            <div>
                ...
                <p class="text-sm text-gray-400 mt-0.5">Manage all product categories</p>
            </div>
        ...
        {{-- Search & Filter --}}
        <form method="GET" action="{{ route('admin-dashboard.categories.index') }}"
                            ...
                            <tr class="hover:bg-purple-50/20 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <span
                                                class="font-semibold text-gray-700 whitespace-nowrap">{{ $category->name }}</span>
                                ...
                                <td class="px-6 py-4 text-gray-500">
                                    <span
                                        class="text-xs font-semibold px-2.5 py-1 rounded-full bg-purple-50 text-purple-600">
